        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors"
            >
              Delete Account
            </button>
          </div>
            ...
            <div className="px-6 py-4">
              ...
              <div className="mt-4">
                ...
                <ul className="mt-2 text-sm text-gray-600 list-disc list-inside space-y-1">
                  <li>All bill types and payment records</li>
                  <li>All expense types and items</li>
              ...
              <div className="mt-6 flex space-x-3">
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="flex-1 px-4 py-2 text-sm font-medium text-white bg-red-600 border border-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {isDeleting ? (
